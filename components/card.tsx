...
export const MdcCard = (props: MdcCardProps) => (
  <div
    ...
    fn2={classes(
      { 'mdc-card': true, 'mdc-card--theme-dark': sDataValue(props.dark) },
      props.classes
    )}
  >
    {props['children']}
      ...
      fn2={classes(
        {
          ...
          'mdc-card__actions--vertical': sDataValue(props.vertical)
        },
        props.classes
      )}
    >
...
export const MdcCard_Media = (props: MdcBaseProps) => (
  <section
    fn1={styles(props.styles)}
    fn2={classes({ 'mdc-card__media': true }, props.classes)}
  >
    {props.children}
  </section>
);
export const MdcCard_MediaItem = (props: MdcMediaItemProps) => (
  <img
    src={sDataValue(props.src) + ''}
    fn1={styles(props.styles)}
    fn2={classes(
      {
        'mdc-card__media-item': true,
        ['mdc-card__media-item--' + sDataValue(props.size as any)]:
          props.size !== null
      },
      props.classes
    )}
...
export const MdcCard_Primary = (props: MdcBaseProps) => (
  <section
    fn1={styles(props.styles)}
    fn2={classes({ 'mdc-card__primary': true }, props.classes)}
  >
    {props.children}
  </section>
);
...
export const MdcCard_Title = (props: MdcCardTextProps) => (
  <h1
    fn1={styles(props.styles)}
    fn2={classes(
      { 'mdc-card__title': true, 'mdc-card__title--large': true },
      props.classes
    )}
  >
...
export const MdcCard_SubTitle = (props: MdcCardTextProps) => (
  <h2
    fn1={styles(props.styles)}
    fn2={classes({ 'mdc-card__subtitle': true }, props.classes)}
  >
    {sDataValue(props.text)}
  </h2>
);
export const MdcCard_SupportingText = (props: MdcCardTextProps) => (
  <h2
    fn1={styles(props.styles)}
    fn2={classes({ 'mdc-card__supporting-text': true }, props.classes)}
  >
    {sDataValue(props.text)}
  </h2>
);
...
export const MdcCard_HorizontalBlock = (props: MdcBaseProps) => (
  <div
    fn1={styles(props.styles)}
    fn2={classes({ 'mdc-card__horizontal-block': true }, props.classes)}
  >
    {props.children}
  </div>
);
