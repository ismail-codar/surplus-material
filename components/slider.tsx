...
export const MdcSlider = (props: MdcSliderProps) => {
    const dom = <div
            ...
            aria-valuemin={sDataValue(props.min) || 0} aria-valuemax={sDataValue(props.max) || 100} aria-valuenow={props.value()}>
            ...
            <div className="mdc-slider__thumb-container">
                {props.discrete ? <div className="mdc-slider__pin">
                    <span className="mdc-slider__pin-value-marker">{props.value()}</span>
                </div> : null}
