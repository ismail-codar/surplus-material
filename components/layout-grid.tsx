...
export type ValueByDeviceSizeType = {
  [k in DeviceSizeType]?: DataSignal<number> | number
};
      ...
      classes: [
        {
          ...
          ['mdc-layout-grid--align-' + sDataValue(props.align)]:
            props.align != null
        },
        props.classes
      ]
...
export const mdcLayoutGridStyle = (
  style: 'column-width' | 'margin' | 'gutter',
  deviceSize: DeviceSizeType,
  value: DataSignal<string> | string
) => {
  return (
    '--mdc-layout-grid-' + style + '-' + deviceSize + ':' + sDataValue(value)
  );
};
