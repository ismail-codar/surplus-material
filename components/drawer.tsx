...
export interface MdcDrawerProps extends MdcBaseProps {
    header: HTMLElement
    open: DataSignal<boolean> | boolean
}
        ...
        classes: [
            {
                ...
                "mdc-temporary-drawer--open": sDataValue(props.open),
            },
            props.classes
        ]
    }) } >
...
export const MdcPermanentDrawer = (props: MdcPermanentDrawerProps) =>
    <nav {...mixins({
        ...
        {props.spacer ? null : <div className="mdc-permanent-drawer__toolbar-spacer"></div>}
        <div className="mdc-list-group">
            {props.children}
        </div>
    </nav>