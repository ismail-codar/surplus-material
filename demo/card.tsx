...
import { SStyleType } from 'surplus-mixins';
...
export = (ctrl: any) => {
  return (
    <div>
      ...
      <section
        className="demo-typography--section mdc-typography"
        id="demo-wrapper"
      >
        <MdcCard
          dark={true}
          classes={{ 'demo-card': true, 'demo-card--bg-demo': true }}
        >
          <MdcCard_Primary>
            <MdcCard_Title text="Title goes here" />
            <MdcCard_SubTitle text="Subtitle here" />
          ...
          <MdcCard_Actions>
            <MdcButton dark={true} rippleEffect={false}>
              Action 1
            </MdcButton>
            <MdcButton dark={true} rippleEffect={false}>
              Action 2
