    ...
    <div>
      <section className="hero">
        <MdcList
          avatar={true}
          towLine={true}
          classes={{ 'two-line-avatar-text-icon-demo': true }}
        >
          <MdcList_Item
            startDetail={
      ...
      <div id="demo-wrapper">
        ...
        <section className="mdc-theme--dark">
          ...
          <MdcList>
            <MdcList_Item
              startDetail={<i className="material-icons">network_wifi</i>}
            >
              Wi-Fi
            </MdcList_Item>
            <MdcList_Item
              startDetail={<i className="material-icons">bluetooth</i>}
            >
              Bluetooth
            </MdcList_Item>
            <MdcList_Item
              startDetail={<i className="material-icons">data_usage</i>}
            >
              Data Usage
            </MdcList_Item>
          </MdcList>
        ...
        <section>
          ...
          <MdcList
            fn={mixins({ attrs: { id: 'avatar-text-icon-demo-list' } })}
            avatar={true}
          >
            <MdcList_Item
              startDetail={
