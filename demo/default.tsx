  ...
  <nav className="mdc-toolbar-fixed-adjust">
    <ul className="catalog-list mdc-list mdc-list--two-line">
      <li className="mdc-list-item">
        <span className="catalog-list-icon mdc-list-item__start-detail">
          <img
            className="catalog-component-icon"
            src="/demo/images/ic_button_24px.svg"
          />
        </span>
      ...
      <li className="mdc-list-item">
        <span className="catalog-list-icon mdc-list-item__start-detail">
          <img
            className="catalog-component-icon"
            src="/demo/images/ic_card_24px.svg"
          />
        </span>
      ...
      <li className="mdc-list-item">
        <span className="catalog-list-icon mdc-list-item__start-detail">
          <img
            className="catalog-component-icon"
            src="/demo/images/ic_selection_control_24px.svg"
          />
        </span>
      ...
      <li className="mdc-list-item">
        <span className="catalog-list-icon mdc-list-item__start-detail">
          <img
            className="catalog-component-icon"
            src="/demo/images/ic_dialog_24px.svg"
          />
        </span>
      ...
      <li className="mdc-list-item">
        <span className="catalog-list-icon mdc-list-item__start-detail">
          <img
            className="catalog-component-icon"
            src="/demo/images/ic_side_navigation_24px.svg"
          />
        </span>
      ...
      <li className="mdc-list-item">
        ...
        <a
          href="/drawer/permanent-drawer-above-toolbar"
      ...
      <li className="mdc-list-item">
        ...
        <a
          href="/drawer/permanent-drawer-below-toolbar"
          className="mdc-list-item__text"
        >
          Drawer
          <span className="mdc-list-item__text__secondary">
      ...
      <li className="mdc-list-item">
        <span className="catalog-list-icon mdc-list-item__start-detail">
          <img
            className="catalog-component-icon"
            src="/demo/images/ic_shadow_24px.svg"
          />
        </span>
        <a href="/elevation" className="mdc-list-item__text">
          Elevation
          <span className="mdc-list-item__text__secondary">
            Shadow for different elevations
          </span>
        </a>
      </li>
      ...
      <li className="mdc-list-item">
        ...
        <a href="/fab" className="mdc-list-item__text">
          ...
          <span className="mdc-list-item__text__secondary">
            The primary action in an application
          </span>
        </a>
      </li>
      ...
      <li className="mdc-list-item">
        <span className="catalog-list-icon mdc-list-item__start-detail">
          <img
            className="catalog-component-icon"
            src="/demo/images/ic_component_24px.svg"
          />
        </span>
        <a href="/icon-toggle" className="mdc-list-item__text">
          Icon toggle
          <span className="mdc-list-item__text__secondary">
            Toggling icon states
          </span>
        </a>
      </li>
      ...
      <li className="mdc-list-item">
        <span className="catalog-list-icon mdc-list-item__start-detail">
          <img
            className="catalog-component-icon"
            src="/demo/images/ic_progress_activity.svg"
          />
        </span>
      ...
      <li className="mdc-list-item">
        <span className="catalog-list-icon mdc-list-item__start-detail">
          <img
            className="catalog-component-icon"
            src="/demo/images/ic_list_24px.svg"
          />
        </span>
        <a href="/list" className="mdc-list-item__text">
          List
          <span className="mdc-list-item__text__secondary">
            Item layouts in lists
          </span>
        </a>
      </li>
      ...
      <li className="mdc-list-item">
        <span className="catalog-list-icon mdc-list-item__start-detail">
          <img
            className="catalog-component-icon"
            src="/demo/images/ic_radio_button_24px.svg"
          />
        </span>
      ...
      <li className="mdc-list-item">
        <span className="catalog-list-icon mdc-list-item__start-detail">
          <img
            className="catalog-component-icon"
            src="/demo/images/ic_ripple_24px.svg"
          />
        </span>
      ...
      <li className="mdc-list-item">
        <span className="catalog-list-icon mdc-list-item__start-detail">
          <img
            className="catalog-component-icon"
            src="/demo/images/ic_menu_24px.svg"
          />
        </span>
      ...
      <li className="mdc-list-item">
        <span className="catalog-list-icon mdc-list-item__start-detail">
          <img
            className="catalog-component-icon"
            src="/demo/images/ic_toast_24px.svg"
          />
        </span>
      ...
      <li className="mdc-list-item">
        <span className="catalog-list-icon mdc-list-item__start-detail">
          <img
            className="catalog-component-icon"
            src="/demo/images/ic_switch_24px.svg"
          />
        </span>
      ...
      <li className="mdc-list-item">
        <span className="catalog-list-icon mdc-list-item__start-detail">
          <img
            className="catalog-component-icon"
            src="/demo/images/ic_tabs_24px.svg"
          />
        </span>
        <a href="/tabs" className="mdc-list-item__text">
          Tabs
          <span className="mdc-list-item__text__secondary">
            Tabs with support for icon and text labels
          </span>
        </a>
      </li>
      ...
      <li className="mdc-list-item">
        <span className="catalog-list-icon mdc-list-item__start-detail">
          <img
            className="catalog-component-icon"
            src="/demo/images/ic_text_field_24px.svg"
          />
        </span>
      ...
      <li className="mdc-list-item">
        <span className="catalog-list-icon mdc-list-item__start-detail">
          <img
            className="catalog-component-icon"
            src="/demo/images/ic_theme_24px.svg"
          />
        </span>
        <a href="/theme" className="mdc-list-item__text">
          Theme
          <span className="mdc-list-item__text__secondary">
            Using primary and accent colors
          </span>
        </a>
      </li>
      ...
      <li className="mdc-list-item">
        <span className="catalog-list-icon mdc-list-item__start-detail">
          <img
            className="catalog-component-icon"
            src="/demo/images/ic_toolbar_24px.svg"
          />
        </span>
      ...
      <li className="mdc-list-item">
        <span className="catalog-list-icon mdc-list-item__start-detail">
          <img
            className="catalog-component-icon"
            src="/demo/images/ic_typography_24px.svg"
          />
        </span>
