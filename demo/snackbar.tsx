...
import { attrs, onmouse } from 'surplus-mixins';
  ...
  return (
    <div>
      <section className="hero">
        <MdcSnackbar cssOnly={true} active={() => true}>
          Message sent
        </MdcSnackbar>
      </section>
      ...
      <section className="example">
        ...
        <div className="mdc-form-field">
          ...
          <label fn={attrs({ for: 'multiline' })} id="multiline-label">
            Multiline
          </label>
        </div>
        <br />
        ...
        <div className="mdc-form-field">
          ...
          <label
            fn={attrs({ for: 'action-on-bottom' })}
            id="action-on-bottom-label"
          >
            Action On Bottom
          </label>
        </div>
        ...
        <div className="mdc-form-field">
          ...
          <label
            fn={attrs({ for: 'dismiss-on-action' })}
            id="dismiss-on-action-label"
          >
            Dismiss On Action
          </label>
        </div>
        ...
        <div className="mdc-textfield">
          ...
          <label
            ...
            fn1={attrs({ for: 'multiline' })}
            fn2={attrs({ for: 'message' })}
          >
            Message Text
          </label>
        </div>
        ...
        <button
          ...
          type="button"
          className="demo-activate-button mdc-button mdc-button--raised mdc-button--secondary"
          id="show-snackbar"
        >
          Show
        </button>
        ...
        <button
          type="button"
          className="demo-activate-button mdc-button mdc-button--raised mdc-button--secondary"
          id="show-start-aligned-snackbar"
        >
          Show Start Aligned
        </button>
        <button
          type="button"
          className="demo-activate-button mdc-button mdc-button--raised mdc-button--secondary"
          id="show-start-aligned-rtl-snackbar"
        >
